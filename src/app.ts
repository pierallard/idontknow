...
export const HORIZONTAL_LEFT_SIZE = (GRID_WIDTH - 1) * CELL_WIDTH / 2;
export const HORIZONTAL_RIGHT_SIZE = (GRID_HEIGHT - 1) * CELL_WIDTH / 2;
export const WORLD_WIDTH = HORIZONTAL_LEFT_SIZE + HORIZONTAL_RIGHT_SIZE;
const WALL_GAP = 10;
export const WORLD_HEIGHT = GRID_WIDTH * CELL_HEIGHT / 2 + GRID_HEIGHT * CELL_HEIGHT / 2 + WALL_GAP;
